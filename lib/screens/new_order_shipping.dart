...
class NewOrderShippingScreen extends StatefulWidget {
  ...
  @override
  State<NewOrderShippingScreen> createState() => _NewOrderShippingScreenState();
}

class _NewOrderShippingScreenState extends State<NewOrderShippingScreen> {
